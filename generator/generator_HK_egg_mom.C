...
void generator_HK_egg_mom(int partition=5, double momentum, int particle, int neutrino, double mass){
  ...
  zmax=(24750/partition-100)/2-200;
		...
		for(int j=1;j<=1;j++){
		  sprintf(filename,"eventlist_HKegg_particle%d_%dMeVpc_mom_%dpart.txt",particle,(int)momentum,partition);
